...
class Event(Base):
    ...
    attendees: Mapped[List[Registration]] = relationship(
        back_populates="event", cascade="all, delete-orphan"
    )
    discussion_posts: Mapped[List[Message]] = relationship(
        back_populates="event", cascade="all, delete-orphan"
    )
...
class Message(Base):
    ...
    parent: Mapped[Optional["Message"]] = relationship(
        "Message", back_populates="replies", remote_side=[id]
    )
